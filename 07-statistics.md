...
P(I|T) = (P(T|I)P(I))/P(T) = 5/11 = 45%

There is a 45% chance that Elvis was an identical twin
...
They primarily differ on the definition of probability.

For Frequentists, probabilities are fundamentally dependent on the frequencies of events.  With a large amount of measurements, the frequency of a value indicates the probability of measuring that value.

For Bayesians, the idea of probability also includes degrees of certainty about the event.  This means that the idea of probability is fundamentally related to knowledge about a certain event.
